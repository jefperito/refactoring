...
Através de uma matriz é possível apresentar as dependências dos componentes de um software de maneira compacta, ela é conhecida como DSM. Disposta pelos seus componentes espalhados na horizontal e na vertical, criando n x m células, essas células representam dependências que são quantificadas, expondo alem de dependências, dependências cíclicas. (Explicar mais e colocar imagem)
